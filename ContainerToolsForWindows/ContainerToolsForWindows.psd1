#
# Module manifest for module 'ContainerToolsForWindows'
#
...
Description       = 'PowerShell functions that allow you to download, install, and configure Containerd, Buildkit, Nerdctl, and Windows CNI for container networks'
...
# FormatsToProcess = @(
#     'ContainerToolsForWindows.Format.ps1xml'
# )

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @(
    'Private\SetupUtilities.psm1'
    'Public\Utilities.psm1',
...
#     ForEach-Object { Get-Module -Name $_ -ListAvailable |
...
FileList = @('ContainerToolsForWindows.Format.ps1xml')
...
PrivateData       = @{
    ...
    PSData = @{
        ...
        Tags = @('Containerd', 'Buildkit', 'Nerdctl', 'WinCNI', 'Windows Containers')
