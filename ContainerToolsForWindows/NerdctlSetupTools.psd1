#
# Module manifest for module 'NerdctlSetupTools'
#
...
Description       = 'Install and setup Container tools on Windows'
...
NestedModules = @(
    ...
    'Public\InstallContainerTools.psm1'
)

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = @(
    'Get-InstallationFiles', 
    'Install-RequiredFeature', 
    ...
    'Start-BuildkitService',                
    'Stop-BuildkitService',
    'Initialize-BuildkitService',                
    'Uninstall-Buildkit',
